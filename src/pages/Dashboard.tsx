	...
	const features = [
		{
			...
			title:
				language === "en" ? "AI-Powered Generation" : "توليد بالذكاء الاصطناعي",
			description:
				language === "en"
					? "Advanced AI creates relevant and challenging questions"
					: "يقوم الذكاء الاصطناعي المتقدم بإنشاء أسئلة ذات صلة وتحديات",
		},
		{
			...
			description:
				language === "en"
					? "Generate comprehensive quizzes in seconds"
		...
		},
		{
			...
			description:
				language === "en"
					? "Support for text input and PDF uploads"
					: "دعم إدخال النص وتحميلات PDF",
		},
	];
